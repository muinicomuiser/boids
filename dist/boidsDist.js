(function () {
    ...
    */
    ...
    const BORDEMENOR = Render.anchoCanvas < Render.altoCanvas ? Render.anchoCanvas : Render.altoCanvas;
    //CONSTANTES
    const NUMEROBOIDS = 200 < Math.floor(BORDEMENOR / 2) ? 200 : Math.floor(BORDEMENOR / 2);
    const ESCALA = 2;
    const VELMAXIMA = 2;
    const RADIOINICIAL = BORDEMENOR / 2;
    const DISTANCIAREPELER = 30;
    const FUERZAREPELER = 6;
    const DISTANCIACOORDINAR = 50;

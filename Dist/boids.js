(function () {
    ...
    const RADIOFORMAGENERADORA = CANVAS.width < CANVAS.height ? CANVAS.width / 2.5 : CANVAS.height / 2.5;
    const NUMEROBOIDS = Math.floor(RADIOFORMAGENERADORA) < 200 ? Math.floor(RADIOFORMAGENERADORA) : 200;
    console.log(NUMEROBOIDS);
    const ESCALA = 1.5;
    const VELMAXIMA = 1.6;
    const ROTARSEGUNVELOCIDAD = true;
    const DISTANCIAREPELER = 20;
    const FUERZAREPELER = 1;
    const DISTANCIACOORDINAR = 30;
